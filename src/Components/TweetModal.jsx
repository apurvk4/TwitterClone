  ...
  render() {
    return (
      <div
        ...
        data-ismodal={this.props.ismodal ? "true" : "false"}
      >
        {this.props.ismodal ? (
        ...
        >
          <div className={style["tweet-left"]}>
            <DeadPool width="46px" height="46px" style={{ fill: "red" }} />
          </div>
          <div className={style["tweet-body"]}>
            <div className={style["tweet-body-text"]}>
              <textarea type="text" placeholder="What's happening ?" />
            </div>
            <div className={style["tweet-body-buttons"]}>
              <div className={style["tweet-body-buttons-uploads"]}>
              ...
              <div className={style["tweet-body-buttons-space"]}></div>
              <div className={style["tweet-body-buttons-submit"]}>
                <button>Tweet</button>
              </div>
            </div>
          </div>

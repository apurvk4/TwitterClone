            ...
            <div className={style["col"]}>
              ...
              <div className={style["col-items"]}>
                <button>
                  ...
                  <span>Not intreseted in this tweet</span>
                </button>
              </div>
              <div className={style["col-items"]}>
                <button>
                  ...
                  <span>unfollow {"@" + this.props.username}</span>
                </button>
              </div>
              <div className={style["col-items"]}>
                <button>
                  ...
                  <span>Add/remove {"@" + this.props.username} from Lists</span>
                </button>
              </div>
              <div className={style["col-items"]}>
                <button>
                  ...
                  <span>Mute {"@" + this.props.username}</span>
                </button>
              </div>
              <div className={style["col-items"]}>
                <button>
                  ...
                  <span>Block {"@" + this.props.username}</span>
                </button>
              </div>
              <div className={style["col-items"]}>
                <button>
